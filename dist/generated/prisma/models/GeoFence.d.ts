...
export type GetGeofenceAggregateType<T extends GeofenceAggregateArgs> = {
    [P in keyof T & keyof AggregateGeofence]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateGeofence[P]> : Prisma.GetScalarType<T[P], AggregateGeofence[P]>;
};
...
export type GetGeofenceGroupByPayload<T extends GeofenceGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<GeofenceGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof GeofenceGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], GeofenceGroupByOutputType[P]> : Prisma.GetScalarType<T[P], GeofenceGroupByOutputType[P]>;
}>>;
export type GeofenceWhereInput = {
    ...
    centerLat?: Prisma.FloatFilter<"Geofence"> | number;
    centerLng?: Prisma.FloatFilter<"Geofence"> | number;
    radiusMt?: Prisma.FloatFilter<"Geofence"> | number;
...
export type GeofenceScalarWhereWithAggregatesInput = {
    ...
    centerLat?: Prisma.FloatWithAggregatesFilter<"Geofence"> | number;
    centerLng?: Prisma.FloatWithAggregatesFilter<"Geofence"> | number;
    radiusMt?: Prisma.FloatWithAggregatesFilter<"Geofence"> | number;
...
export type GeofenceCreateInput = {
    ...
    Company: Prisma.CompanyCreateNestedOneWithoutGeofenceInput;
};
...
export type GeofenceUpdateInput = {
    ...
    radiusMt?: Prisma.FloatFieldUpdateOperationsInput | number;
    isActive?: Prisma.BoolFieldUpdateOperationsInput | boolean;
    createdAt?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string;
    updatedAt?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string;
    Company?: Prisma.CompanyUpdateOneRequiredWithoutGeofenceNestedInput;
};
...
export type GeofenceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "name" | "description" | "companyId" | "centerLat" | "centerLng" | "radiusMt" | "isActive" | "createdAt" | "updatedAt", ExtArgs["result"]["geofence"]>;
...
export type GeofenceCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<GeofenceFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface GeofenceDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Geofence'];
        meta: {
            name: 'Geofence';
        };
    };
     ...
     * })
    **/
    count<T extends GeofenceCountArgs>(args?: Prisma.Subset<T, GeofenceCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], GeofenceCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends GeofenceGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, GeofenceGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetGeofenceGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface GeofenceFieldRefs {
    ...
    readonly radiusMt: Prisma.FieldRef<"Geofence", 'Float'>;
