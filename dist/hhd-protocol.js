...
export function buildResponse8001(terminalId, serialNumber, answerId) {
...
export function buildSealCommand(terminalId, serialNumber, seal, operatorName = "admin") {
...
export function buildWriteICCard(terminalId, serialNumber, blockNumber, address, cardId) {
...
export function buildEnableFingerprintRegister(terminalId, serialNumber, blockNumber = 0, address = 0) {
...
export function buildEnableAutoCardBinding(terminalId, serialNumber, minutes = 5) {
...
export function buildSetCardTriggerMode(terminalId, serialNumber, mode = 0) {
    const body = Buffer.concat([
        Buffer.from([0x01]),
        Buffer.from([0x2b]),
        Buffer.from([0x01]),
...
//# sourceMappingURL=hhd-protocol.js.map